...
export default async function OrderSuccessPage({
  ...
  if (submitted === "custom") {
    submittedMessage =
      "Your custom order request was submitted. Brandy will review your order and email you a quoted price — you won't be charged until you review and pay.";
  } else if (submitted === "rush" || submitted === "1") {
    submittedMessage =
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-16 text-center">
      ...
      {order && !order.paidInFull && order.balanceDueCents > 0 && !submittedMessage && (
